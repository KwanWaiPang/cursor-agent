...
4. 按 **B** 打开全国图鉴（#001–1025）；未目击为剪影。无上游 3D 的编号回退 PokeAPI / Showdown 2D 立绘
5. 进度自动保存在浏览器 `localStorage`（队伍、图鉴目击、位置）；标题屏可「继续旅程」或「重新开始」
...
当前可玩范围为真新镇开局（研究所 + 1 号道路高草对战 + 全国图鉴浏览）。常青市 / 森林 / 尼比道馆的第一人称扩展将沿同一程序化管线继续增加。
