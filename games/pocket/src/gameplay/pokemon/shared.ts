...
export const STARTERS: { id: StarterId; name: string; type: string; blurb: string }[] = [
  { id: 'bulbasaur', name: '妙蛙种子', type: '草', blurb: '种子宝可梦。性格沉稳，背上的种子会一起长大。' },
  { id: 'charmander', name: '小火龙', type: '火', blurb: '蜥蜴宝可梦。尾巴上的火焰能反映它的心情。' },
  { id: 'squirtle', name: '杰尼龟', type: '水', blurb: '小龟宝可梦。甲壳会随成长变得坚硬。' },
];
