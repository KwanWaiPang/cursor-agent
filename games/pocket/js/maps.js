...
export const MAPS = {
  ...
  lab: {
    ...
    warps: [{ x: 6, y: 10, to: "town", tx: 15, ty: 7, facing: "down" }],
    npcs: [
  ...
  viridian: {
    ...
    warps: [
      ...
      { x: 5, y: 6, to: "center", tx: 5, ty: 7, facing: "up" },
      { x: 18, y: 6, to: "mart", tx: 4, ty: 6, facing: "up" },
  ...
  center: {
    ...
    warps: [{ x: 5, y: 7, to: "viridian", tx: 5, ty: 7, facing: "down" }],
    npcs: [
  ...
  mart: {
    ...
    warps: [{ x: 4, y: 6, to: "viridian", tx: 18, ty: 7, facing: "down" }],
    npcs: [
  ...
  forest: {
    ...
    spawns: [
      { species: "caterpie", weight: 22, levels: [4, 6] },
      { species: "metapod", weight: 12, levels: [5, 6] },
      { species: "weedle", weight: 22, levels: [4, 6] },
      { species: "kakuna", weight: 12, levels: [5, 6] },
      { species: "pikachu", weight: 8, levels: [5, 7] },
      { species: "oddish", weight: 16, levels: [5, 7] },
      { species: "paras", weight: 8, levels: [5, 6] },
    ],
  ...
  pewter: {
    ...
    warps: [
      ...
      { x: 6, y: 6, to: "pewter_center", tx: 5, ty: 7, facing: "up" },
      { x: 18, y: 6, to: "pewter_mart", tx: 4, ty: 6, facing: "up" },
      { x: 10, y: 12, to: "gym", tx: 5, ty: 10, facing: "up" },
    ],
    npcs: [
  ...
  pewter_center: {
    ...
    warps: [{ x: 5, y: 7, to: "pewter", tx: 6, ty: 7, facing: "down" }],
  ...
  pewter_mart: {
    ...
    warps: [{ x: 4, y: 6, to: "pewter", tx: 18, ty: 7, facing: "down" }],
    npcs: [
      {
        x: 3,
        y: 3,
  ...
  gym: {
    ...
    warps: [{ x: 5, y: 10, to: "pewter", tx: 10, ty: 13, facing: "down" }],
    npcs: [
      {
        x: 5,
        y: 3,
      ...
      },
      {
        ...
        trainer: {
          ...
          party: [{ species: "diglett", level: 10 }],
          intro: ["想挑战馆主，先过我这关！"],
          win: ["你可以去找小刚了。中途可以出门去中心恢复。"],
          lose: ["还早呢！"],
        },
        lines: ["道馆里尽是岩石属性！"],
      },
